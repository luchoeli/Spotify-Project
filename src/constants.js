...
export const SEARCH_ALBUM_ID_BEGIN = 'SEARCH_ALBUM_ID_BEGIN'
export const SEARCH_ALBUM_ID_SUCCESS = 'SEARCH_ALBUM_ID_SUCCESS'
export const SEARCH_ALBUM_ID_FAILURE = 'SEARCH_ALBUM_ID_FAILURE'